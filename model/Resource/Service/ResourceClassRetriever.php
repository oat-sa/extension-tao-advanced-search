...
class ResourceClassRetriever extends ConfigurableService
{
    use OntologyAwareTrait;

    public function retrieve(): core_kernel_classes_ClassIterator
    {
        $classes = [];
        ...
        return new core_kernel_classes_ClassIterator(array_values($classes));
    }
}
